    ...
    <div>
        ...
        <el-form label-width="120px">
            ...
            <el-form-item label="销售属性">
                <el-select placeholder="请选择">
                    <el-option v-for="(attr,index) in baseSaleArrrList" :key="attr.id" :value="attr.id" :label="attr.name"></el-option>
...
// 引入spu独享的相关类型 
import type { BaseSaleAttrListModel, SpuModel } from '@/api/product/model/spuModel';
// 引入枚举的类型
